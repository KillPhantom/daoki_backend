 ...
 */
@Component
public class BravetIdGenerator implements IdGenerateService {
    ...
    public BravetIdGenerator() {
//        long dataCenterId = 100L;
//        long machineId = 100L;
...
//        }
        this.dataCenterID = 1000L;
        this.machineId = 10000L;
        dataCenterTag = 1000L << DATA_CENTER_SHIFT;
